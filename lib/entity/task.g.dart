...
_$TaskPreparedImpl _$$TaskPreparedImplFromJson(Map<String, dynamic> json) => _$TaskPreparedImpl(
      ...
      fullFilledDateTime: const NullableTimestampConverter().fromJson(json['fullFilledDateTime'] as Timestamp?),
...
Map<String, dynamic> _$$TaskPreparedImplToJson(_$TaskPreparedImpl instance) => <String, dynamic>{
      ...
      'fullFilledDateTime': const NullableTimestampConverter().toJson(instance.fullFilledDateTime),
